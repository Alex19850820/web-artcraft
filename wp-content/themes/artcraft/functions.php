...
if ( ! function_exists( 'artcraft_setup' ) ) :
	...
	function artcraft_setup() {
		 ...
		 * If you're building a theme based on artcraft, use a find and replace
		 * to change 'artcraft' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'artcraft', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'artcraft' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'artcraft_custom_background_args', array(
 ...
 */
function artcraft_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'artcraft_content_width', 640 );
}
add_action( 'after_setup_theme', 'artcraft_content_width', 0 );
 ...
 */
	...
	wp_enqueue_style( 'moviesta-style', get_template_directory_uri() . '/css/fine-uploader-gallery.css' );
	// для внешних стилей
	...
	*/
	...
	wp_enqueue_script( 'artcraft-imgload', get_template_directory_uri() . '/js/imagesloaded.pkgd.min.js', [], '', true );
	wp_enqueue_script( 'artcraft-masonry', get_template_directory_uri() . '/js/masonry.pkgd.min.js', [], '', true );
	wp_enqueue_script( 'artcraft-script_form', get_template_directory_uri() . '/js/script_form.js', [], '', true );
	wp_enqueue_script( 'artcraft-focus_fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', [], '', true );
	...
	*/
	...
	wp_enqueue_script( 'artcraft-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'artcraft-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
